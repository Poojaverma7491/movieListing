     ...
     sx={{
      ...
      {loading ? (
        ...
        sx={{
          ...
          <Skeleton variant="rectangular" width={200} height={300} sx={{ mx: 'auto', borderRadius: 2, height: { xs: 100, sm: 200, md: 20, lg: 280 }, width: { xs: 140, sm: 160, md: 185 }, bgcolor: 'grey.700' }} />
        </Box>
      ) : (
        <Swiper
          modules={[Autoplay]}
